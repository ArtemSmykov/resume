...
\leftheader{%
  {\LARGE\bfseries\sffamily Смыков Артемий Валерьевич}

  \makefield{\faEnvelope[regular]}{\href{mailto:avsmykov@edu.hse.ru}{\texttt{avsmykov@edu.hse.ru}}}
\makefield{\faTelegramPlane}{\href{https://t.me/overleaf_example}{\texttt{@smkv03}}}  \makefield{\faLinkedin}
  {\href{http://www.linkedin.com/in/example/}{\texttt{example}}}

  %% Next line
\makefield{\faPhone}{\href{tel:+79294176546}{\texttt{+7 (929) 714-56-64}}}
\makefield{\faGithub}{\href{https://github.com/ArtemSmykov}{\texttt{ArtemSmykov}}}
